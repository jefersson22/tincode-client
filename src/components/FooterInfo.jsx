...
export function FooterInfo() {
  return (
    <div className="tc-footer-info">
      ...
      <p className="tc-footer-info_tagline">
        Aprende a programar con cursos prácticos, guías escritas por desarrolladores reales y una comunidad que sigue el ritmo de la industria.
      </p>
      <div className="tc-footer-info_socials">
        {SOCIALS.map((s) => (
          <a
            key={s.label}
            href={s.href}
            ...
            rel="noreferrer"
            aria-label={s.label}
            className="tc-footer-info_social-btn"
          >
